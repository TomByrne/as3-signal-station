package org.tbyrne.queueing
{
	...
	public class ThreadedQueueMediator extends AbstractMediator
	{
		...
		public function ThreadedQueueMediator(threadId:String, intendedThreadSpeed:Number=0.5)
		{
			_queue = new ThreadedQueue(threadId,intendedThreadSpeed);
		...
		override public function handleNotification(note:INotification):void {
			...
			switch (note.getName()) {
				...
				case ThreadedQueueNotifications.ADD_QUEUE_ITEMS:
					items = note.getBody() as Vector.<IQueueItem>;
