package org.farmcode.sodalityLibrary.external.browser.advice
{
	...
	public class OpenBrowserWindowAdvice extends Advice implements IOpenBrowserWindowAdvice
	{
		...
		public function OpenBrowserWindowAdvice(windowURL:String=null, windowName:String=null, windowSize:Rectangle=null, windowIsResizable:Boolean=true, displayChrome:Boolean = true, displayScrollBars:Boolean = true){
