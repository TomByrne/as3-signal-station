package org.tbyrne.actLibrary.display.visualSockets.debug
{
	...
	{
		public static function outlineSocket(graphics:Graphics, socketBundle:SocketManager, recursive:Boolean=true, colors:Array=null):void{
			if(!colors){
		...
		private static function _outlineSocket(graphics:Graphics, socketBundle:SocketManager, recursive:Boolean, colors:Array, gen:int):void{
			...
			if(recursive){
				...
				for each(var childBundle:SocketManager in socketBundle.childSockets){
