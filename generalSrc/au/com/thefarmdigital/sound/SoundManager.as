...
{
	import au.com.thefarmdigital.sound.soundControls.IHeroSoundControl;
	...
	[Event(name="playbackBegun",type="au.com.thefarmdigital.sound.SoundEvent")]
	...
	public class SoundManager extends EventDispatcher
	{
		...
		protected function _playSound(sound:ISoundControl, dispatchEvent:Boolean):Boolean{
			...
			if(_allSounds[sound] && !pendingStop && !inQueue) {
				...
				throw new SoundError("This ISoundControl object has already been added to the SoundManager");
			}else{
				if(inQueue){
