package au.com.thefarmdigital.display
{
	...
	public class InOutOneDimAnimationDisplay extends MovieClip
	{
		...
		public function InOutOneDimAnimationDisplay(target: MovieClip = null)
		{
			super();
		...
		public function set shown(shown: Boolean): void
		{
			if (shown != this._shown)
			{
				...
				if (this._shown)
				{
					this._direction = InOutOneDimAnimationDisplay.FORWARD;
				}
				else
				{
					this._direction = InOutOneDimAnimationDisplay.REVERSE;
				}
				this.running = true;
			}
		}
		...
		{
			if ((this._direction == InOutOneDimAnimationDisplay.FORWARD && this.currentFrame == this.totalFrames) ||
				(this._direction == InOutOneDimAnimationDisplay.REVERSE && this.currentFrame == 1))
			{
				this.running = false;
