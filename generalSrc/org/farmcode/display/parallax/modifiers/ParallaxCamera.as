package org.farmcode.display.parallax.modifiers
{
	...
	import org.farmcode.display.parallax.Point3D;
	...
	public class ParallaxCamera extends Point3D implements IParallaxModifier
	{
		...
		public function inverseScale(depth:Number):Number{
			...
			if(_focalLength){
				...
				var scale:Number = _focalLength / (_focalLength + depth);
				return 1/scale;
			}else{
				return 1;
			}
		...
		public function modifyItem(item:IParallaxDisplay, container:DisplayObjectContainer):void
		{
			...
			{
				var point:Point3D = getItemPointAndScale(item,this,_focalLength);
