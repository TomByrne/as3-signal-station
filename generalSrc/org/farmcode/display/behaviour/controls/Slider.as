package org.farmcode.display.behaviour.controls
{
	...
	public class Slider extends Control
	{
		...
		override protected function bindToAsset() : void{
			...
			_button.asset = containerAsset;
			_track = containerAsset.getChildByName(TRACK) as InteractiveObject;
			
			_assumedDirection = (_track.width>_track.height?Direction.HORIZONTAL:Direction.VERTICAL);
			
			_thumb.asset = containerAsset.getChildByName(THUMB) as InteractiveObject;
