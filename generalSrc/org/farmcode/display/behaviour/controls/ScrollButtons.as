package org.farmcode.display.behaviour.controls
{
	...
	public class ScrollButtons extends LayoutViewBehaviour
	{
		...
		override protected function bindToAsset() : void{
			super.bindToAsset();
			_foreButton.asset = containerAsset.getChildByName("foreButton");
			_aftButton.asset = containerAsset.getChildByName("aftButton");
		}
