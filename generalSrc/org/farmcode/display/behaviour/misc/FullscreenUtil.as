package org.farmcode.display.behaviour.misc
{
	...
	public class FullscreenUtil
	{
		...
		public function get view():ILayoutViewBehaviour{
			return _view;
		}
		public function set view(value:ILayoutViewBehaviour):void{
			if(_view!=value){
		...
		private var _view:ILayoutViewBehaviour;
		
		private var _oldParent:DisplayObjectContainer;
		private var _oldDepth:int;
		private var _lastStage:Stage;
		
		public function FullscreenUtil(view:ILayoutViewBehaviour=null){
			this.view = view;
		}
