package org.farmcode.display.behaviour.containers
{
	...
	public class TabBar extends AbstractList
	{
		...
		public function TabBar(asset:DisplayObject=null){
			super(asset);
		...
		override protected function onAddRenderer(layout:RendererGridLayout, renderer:IViewBehaviour) : void{
		...
		override protected function onRemoveRenderer(layout:RendererGridLayout, renderer:IViewBehaviour) : void{
