package org.farmcode.actLibrary.application.states
{
	...
	import org.farmcode.actLibrary.application.states.actTypes.*;
	import org.farmcode.actLibrary.application.states.acts.*;
	import org.farmcode.actLibrary.application.states.reactors.IAppStateReactor;
	...
	public class AppStateActor extends UniversalActorHelper
	{
		...
		public function AppStateActor(){
			...
			addUniversalAct(_setSerialisedStateAct);
			
			_setAppStateAct = new SetAppStateAct();
			addUniversalAct(_setAppStateAct);
		}
