package org.farmcode.sodalityWebApp.appState.states
{
	...
	import org.farmcode.sodalityWebApp.appState.reactors.DispatchAdviceReactor;
	...
	public class DefaultAppState extends AbstractAppState
	{
		...
		private var reactorAdvice:LookupFillSocketAdvice;
		private var defaultReactor:DispatchAdviceReactor;
		
		public function DefaultAppState(){
			defaultReactor = new DispatchAdviceReactor();
			var adviceProps:Dictionary = new Dictionary();
			adviceProps["dataPath"] = "*";
			defaultReactor.adviceProps = adviceProps;
			defaultReactor.advice = reactorAdvice = new LookupFillSocketAdvice();
		}
