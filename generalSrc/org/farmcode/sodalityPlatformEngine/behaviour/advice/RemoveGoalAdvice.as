package org.farmcode.sodalityPlatformEngine.behaviour.advice
{
	...
	import org.farmcode.sodalityPlatformEngine.behaviour.adviceTypes.IRemoveGoalAdvice;

	public class RemoveGoalAdvice extends AbstractBehaviourAdvice implements IRemoveGoalAdvice
	{
		...
		public function RemoveGoalAdvice(goalPath:String=null, goal:IGoal=null, behavingItemPath:String=null, 
			behavingItem:IBehavingItem=null)
		{
		...
		{
			return new AddGoalAdvice(_goalPath, this.goal, _behavingItemPath, this.behavingItem);
		}
	}
}